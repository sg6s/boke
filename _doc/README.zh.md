...
### [我的博客在这里 &rarr;](http://sg6s.github.io)
...
我的博客仓库——`sg6s.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家做了一个稳定版的模板。大家可以直接fork模板——`sg6sblog-boilerplate`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。

```
$ git clone git@github.com:sg6s/sg6sblog-boilerplate.git
```

**[在这里预览模板 &rarr;](http://sg6s.github.io/sg6sblog-boilerplate/)**
...
* 解决了代码过长自动换行的bug,替换为横向滚动条。详情请见[issue#15](https://github.com/sg6s/sg6s.github.io/issues/15)
...
* 如果你喜欢我的这个博客模板，请在`sg6s.github.io`这个repository点个赞——右上角**star**一下。
...
```
# Site settings
title: sg6s Blog             # 你的博客网站标题
SEOTitle: sg6s Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: sg6s     # 你的github账号
weibo_username: sg6s      # 你的微博账号，底部链接会自动更新的。
...
sidebar-avatar: /img/avatar-sg6s.jpg     #你的大头贴，请使用绝对地址.
```
...
ga_domain: sg6s.github.io			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/sg6s/sg6s.github.io/issues/6) 中我被问到：怎么样才能让标题底图好看呢？
...
我的博客标题是 **“sg6s Blog”** 但是我想要在搜索的时候显示 **“云海的博客 | sg6s Blog”** ，这个就需要SEO Title来定义了。
