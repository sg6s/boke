...
```yml
# Site settings
title: sg6s Blog             # title of your website
SEOTitle: sg6s Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: sg6s     # modify this account to yours
weibo_username: sg6s      # the footer woule be auto-updated.
...
For instance, [Hello 2015])(https://sg6s.github.io/boke//2015/01/29/hello-2015/) has the front-matter of this:
...
1. a _text style_ header like [this](https://sg6s.github.io/boke//2019/09/08/spacemacs-workflow/) with
...
![](http://sg6s.github.io/img/blog-sidebar.jpg)
...
sidebar-avatar: /img/avatar-sg6s.jpg     # use absolute URL.
```
...
![](http://sg6s.github.io/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://sg6s.github.io/js-module-7day/"
---
```
...
It's possible that you want the two things different. For me, my site-title is **“sg6s Blog”** but I want the title shows in search engine is **“云海的博客 | sg6s Blog”** which is multi-language.
...
- Brand new [Archive](https://sg6s.github.io/boke//archive/) page! It combines previous Archive and Tag page and it's backward-cmpatible.
...
- Fixed [issue#15](https://github.com/sg6s/sg6s.github.io/issues/15) about code wrap.
...
<img src="http://sg6s.github.io/img/blog-md-navbar.gif" width="320" />
