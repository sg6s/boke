...
iframe:     "//sg6s.github.io/css-sucks-2015/"
date:       2015-12-28
author:     "sg6s"
tags:
    - Web
...
### [Watching Fullscreen →](https://sg6s.github.io/boke//css-sucks-2015/)

<div class="visible-md visible-lg">
<img src="//sg6s.github.io/css-sucks-2015/attach/qrcode.png" width="350"/>
<small class="img-hint">你也可以通过扫描二维码在手机上观看</small>
</div>


这个 Web Slides 开源在[我的 Github 上](https://github.com/sg6s/css-sucks-2015)，欢迎你帮助我完善这个展示文稿，你可以给我提 issue，可以 fork & pull request。如果它能帮助到你了，希望你还能不吝啬 star 一下这个项目
